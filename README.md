...
| Plugin | 仓库 | 状态 |
|---|---|---|
| `indoor-layout` | [`vibedrafting/bimcanvas-plugin-indoor-layout`](https://github.com/vibedrafting/bimcanvas-plugin-indoor-layout) | 官方首个 reference plugin —— 住宅家具布置 |
